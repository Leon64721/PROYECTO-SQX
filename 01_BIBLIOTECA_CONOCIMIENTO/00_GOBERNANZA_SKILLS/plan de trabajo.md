...
| Versión | 1.0 |
| Estado general | EN ORGANIZACIÓN |
...
Fase 0: establecer la base documental
Objetivo:

Crear esta gobernanza.
Definir ubicación.
Definir estados.
Definir reglas de actualización.
Estado:

[V] Plan maestro definido.
 Archivo guardado en GitHub.
 Archivo agregado a CLAUDE.md.
Fase 1: inventario de skills
Objetivo:

Identificar todas las skills, herramientas y documentos.
...
Pendiente
 Guardar este archivo en GitHub.
 Crear REGISTRO_DE_SKILLS.md.
 Crear MAPA_DE_FRENTES.md.
 Crear MATRIZ_DE_ACTIVACION.md.
 Crear SKILL_CONTRACTS.md.
 Auditar completamente sqx-lab.
 Ejecutar /sqx-setup.
 Ejecutar /sqx-doctor.
 Auditar la skill de bloques personalizados.
 Auditar las cuatro skills de Custom Projects.
 Crear prueba de bloque ORB.
 Validar un grupo ORB.
 Validar una plantilla ORB.
 Validar un Custom Project pequeño.
 Ejecutar robustez.
 Integrar análisis.
 Separar formalmente el agente ML.
 Integrar Qlib → ONNX → SQX.
 Validar despliegue.
