...
allowed-tools: Bash(python engine/*), Read, Write, Edit
---
...
**On first use you MUST ask the user where StrategyQuant X is installed.** Do not skip this.
Do not silently auto-detect and proceed — asking for the folder is a required step, even if a
guess is available. The flow is:
