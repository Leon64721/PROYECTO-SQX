...
Inicia el flujo completo SQX Custom Project para **[NDXm_TICK_UTCPlus02]** en bróker **[Tickmill - Nasdaq]** capital **[1000 usd]** con **4** edges y temporalidad candidata **[M3, M15, H1]**.
...
- **Costos Inyectados:**
  ...
  - Point value in $: 1
  - Pip/Tick step: None
  - Default spread: 100 pips
  - Default slippage: 1 pips
  - Min distance: None
  - Order size multiplier: None
  - Order size step: None
  - Comisión: $0.0
  - Swap: None (Long: -4.95 / Short: -1.3)
  - Triple swap on: None
  - Rollout hour: None
